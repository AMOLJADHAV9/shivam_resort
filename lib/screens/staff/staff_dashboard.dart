...
class _StaffDashboardState extends ConsumerState<StaffDashboard> {
  ...
  String reportFilterStatus =
      "All"; // "All", "pre-booked", "occupied", "checked-out"
  ...
  // Multi-Category Booking State
  List<Map<String, dynamic>> multiBookingItems = [];
  String paymentMethod = "Cash"; // "Cash" or "UPI"

  final Map<String, dynamic> inventory = {
    "Cottages": {
      "Magic Guest House - 2 Bed Cottage": [
        501,
        502,
        503,
        504,
    ...
    "Meeting Hall": {"Royal Dine - 20 Persons": 1},
    "Saptapadi Hall": {
  ...
  void openCustomerForm() {
    ...
    String? localCapacity;
    Set<dynamic> localUnits = {};
    final localRentController = TextEditingController();
    final localAdvController = TextEditingController();
    final localGstController = TextEditingController(text: "0");
    final localDiscountController = TextEditingController(text: "0");
    final localRemController = TextEditingController();
    ...
    localRentController.addListener(updateRemaining);
    localAdvController.addListener(updateRemaining);
    localGstController.addListener(updateRemaining);
    localDiscountController.addListener(updateRemaining);

    // Clear previous state for a fresh booking
    ...
    _idImageBack = null;
    _guestPhoto = null;
    multiBookingItems.clear();
    paymentMethod = "Cash";
    String bookingType = "Confirm"; // Default to confirmed
    ...
    showModalBottomSheet(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setModalState) {
          ...
          double totalAdv = 0;
          double totalRem = 0;
          for (var item in multiBookingItems) {
            grandTotal += (item['total'] as num).toDouble();
            totalAdv += (item['advance'] as num).toDouble();
            totalRem += (item['remaining'] as num).toDouble();
          }
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // ID Proof Section (Conditional & Optional)
                  if (multiBookingItems.any(
                        (i) =>
                            i['category'] == "Cottages" ||
                            i['category'] == "Lodging Deluxe",
                      ) ||
                      localCategory == "Cottages" ||
                      localCategory == "Lodging Deluxe") ...[
                    const Text(
                      "ID PROOF (Optional)",
                      style: TextStyle(
                        fontSize: 11,
                      ...
                      children: [
                        Expanded(
                          child: TextButton.icon(
                            ...
                            label: Text(
                              _idImage != null ? "ID Front OK" : "ID Front",
                        ...
                        Expanded(
                          child: TextButton.icon(
                            onPressed: () async {
                              ...
                              if (picked != null)
                                setModalState(
                                  () => _idImageBack = File(picked.path),
                                );
                            },
                            icon: Icon(
                              Icons.camera_alt,
                              size: 16,
                              color: _idImageBack != null
                                  ? Colors.green
                                  : brandPurple,
                            ),
                            label: Text(
                              _idImageBack != null ? "ID Back OK" : "ID Back",
                              style: const TextStyle(fontSize: 10),
                            ),
                          ),
                        ),
                        Expanded(
                          child: TextButton.icon(
                            onPressed: () async {
                              ...
                              if (picked != null)
                                setModalState(
                                  () => _guestPhoto = File(picked.path),
                                );
                            },
                            icon: Icon(
                              Icons.face,
                              size: 16,
                              color: _guestPhoto != null
                                  ? Colors.green
                                  : brandPurple,
                            ),
                            label: Text(
                              _guestPhoto != null ? "Photo OK" : "Guest Photo",
                              style: const TextStyle(fontSize: 10),
                            ),
                          ),
                        ),
                  ...
                  if (selectedDate != null && expectedCheckOutDate != null)
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Builder(
                          builder: (context) {
                            int totalMinutes = expectedCheckOutDate!
                                .difference(selectedDate!)
                                .inMinutes;
                            int totalHours = expectedCheckOutDate!
                                .difference(selectedDate!)
                                .inHours;
                            int days = (totalMinutes / 1440.0).ceil();
                            if (days <= 0) days = 1;
                            ...
                            if (date != null) {
                              ...
                              if (time != null) {
                                ...
                                if (expectedCheckOutDate != null &&
                                    newInDate.isAfter(expectedCheckOutDate!)) {
                                  ...
                                  setModalState(() => selectedDate = newInDate);
                                }
                              }
                            }
                          },
                            ...
                            if (date != null) {
                              ...
                              if (time != null) {
                                ...
                                if (selectedDate != null &&
                                    newOutDate.isBefore(selectedDate!)) {
                                  messengerKey.currentState?.showSnackBar(
                                    const SnackBar(
                                      content: Text(
                                  ...
                                  setModalState(
                                    () => expectedCheckOutDate = newOutDate,
                                  );
                                }
                              }
                            }
                      ...
                      children: [
                        ...
                        if (localCategory != null)
                          DropdownButtonFormField<String>(
                            ...
                            items: (inventory[localCategory!] as Map).keys
                                .map(
                          ...
                          Consumer(
                            builder: (context, ref, child) {
                              ...
                              return activeBookingsAsync.when(
                                data: (bookings) {
                                  final available =
                                      inventory[localCategory!][localCapacity!];
                                  ...
                                  return Wrap(
                                    spacing: 6,
                                    children: list.map((u) {
                                      // Determine if this specific unit is currently in use and overlaps with selected dates
                                      String? unitStatus;
                                      bool isAvailable = true;
                                      String? overlappingCleaningBookingId;

                                      for (var b in bookings) {
                                        // Match by category AND unit number
                                        if (b['category'] == localCategory) {
                                          final bUnits =
                                              b['unitNumbers'] as List?;
                                          final bUnit = b['unitNumber'];

                                          bool matches = false;
                                          if (bUnits != null) {
                                            matches = bUnits.any(
                                              (bu) =>
                                                  bu.toString() == u.toString(),
                                            );
                                          } else if (bUnit != null) {
                                            matches =
                                                bUnit.toString() ==
                                          ...
                                          if (matches) {
                                            ...
                                            // Fallback to "now" and "now+24h" to allow sensible availability checks
                                            // even before the user explicitly selects dates in the form.
                                            final testStart =
                                            ...
                                            if (b['status'] == 'cleaning') {
                                              final cleanUntil =
                                                  (b['cleaningUntil']
                                                      ...
                                                      ?.toDate();
                                              if (cleanUntil != null) {
                                                // Overlaps if the new booking arriving date is BEFORE the cleaning finishes
                                                if (testStart.isBefore(
                                                  cleanUntil,
                                                )) {
                                                  overlaps = true;
                                                }
                                              } else {
                                                // Graceful fallback if data is corrupt
                                                if (testStart.isBefore(
                                                  DateTime.now().add(
                                              ...
                                              if (bStart != null &&
                                                  bEnd != null) {
                                                DateTime actualEnd = bEnd;
                                                // If guest overstays, the room is practically blocked until at least NOW
                                                ...
                                                if (testStart.isBefore(
                                                    ...
                                                    testEnd.isAfter(bStart)) {
                                                  overlaps = true;
                                                }
                                              }
                                              // We intentionally DO NOT set overlaps=true if bStart or bEnd is null.
                                              // This prevents corrupt database records from permanently blocking units.
                                            }

                                            if (overlaps) {
                                              unitStatus = b['status'];
                                              if (b['status'] == 'cleaning') {
                                                // Instead of making it unavailable, track it to show a prompt
                                                overlappingCleaningBookingId =
                                                    b['id'];
                                              } else {
                                                isAvailable = false;
                                              }
                                              break; // Found an overlapping booking, stop checking this unit
                                            }
                                          }
                                        }
                                      }

                                      final isSelected = localUnits.contains(u);
                                      Color? chipColor;
                                      ...
                                      if (unitStatus == 'cleaning') {
                                        ...
                                        label += " (CHECKED-IN)";
                                        if (!isSelected)
                                          chipColor = brandGreen.withOpacity(
                                            0.2,
                                          );
                                      } else if (unitStatus == 'pre-booked') {
                                        label += " (PRE-BOOKED)";
                                        if (!isSelected)
                                        ...
                                        onSelected: isAvailable
                                            ? (val) {
                                                if (val &&
                                                    overlappingCleaningBookingId !=
                                                        null) {
                                                  // Intercept selection to show prompt for cleaning units
                                                  showDialog(
                                                    context: context,
                                                    builder: (ctx) => AlertDialog(
                                                      ...
                                                      content: const Text(
                                                        "This unit is currently in its cleaning phase.\n\nIs it ready for the next guest?",
                                                      ),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                            ...
                                            : null, // Disable selection if occupied/prebooked
                          ...
                          children: [
                            Row(
                              children: [
                                Expanded(
                                  child: TextField(
                                    controller: localRentController,
                                    keyboardType: TextInputType.number,
                                    decoration: const InputDecoration(
                                      labelText: "Package Rent",
                                      isDense: true,
                                    ),
                                  ),
                                ),
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: TextField(
                                    controller: localDiscountController,
                                    keyboardType: TextInputType.number,
                                    decoration: const InputDecoration(
                                      labelText: "Discount (%)",
                                      isDense: true,
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              if (localCategory == null ||
                                  localCapacity == null ||
                                  localUnits.isEmpty ||
                                  localRentController.text.isEmpty) {
                                messengerKey.currentState?.showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      "Please fill all category details and select units",
                                    ),
                                  ),
                                );
                                return;
                              ...
                              final rent =
                                  double.tryParse(localRentController.text) ??
                                  0;
                              final adv =
                              ...
                              setModalState(() {
                                ...
                                localCapacity = null;
                                localUnits = {};
                                localRentController.clear();
                                localAdvController.clear();
                                localGstController.text = "0";
                                localDiscountController.text = "0";
                                localRemController.clear();
                              });
                            },
                            icon: const Icon(Icons.add, size: 18),
                            label: const Text("Add to Booking List"),
                  ...
                  // --- 3. Add Extra Bed Section (ROOMS ONLY) ---
                  if (localCategory == "Cottages" ||
                      localCategory == "Lodging Deluxe")
                    Container(
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: TextField(
                                  controller: extraBedCountController,
                                  keyboardType: TextInputType.number,
                                  decoration: const InputDecoration(
                              ...
                              Expanded(
                                child: TextField(
                                  controller: extraBedChargeController,
                                  keyboardType: TextInputType.number,
                                  decoration: const InputDecoration(
                                    labelText: "Charge/Bed (₹)",
                                    isDense: true,
                                    border: OutlineInputBorder(),
                                  ),
                                ),
                          ...
                          Center(
                            child: ElevatedButton.icon(
                              onPressed: () {
                                ...
                                if (count <= 0) {
                                  messengerKey.currentState?.showSnackBar(
                                    const SnackBar(
                                      content: Text(
                                        "Please enter a valid number of extra beds",
                                      ),
                                    ),
                                  );
                                  return;
                              ...
                              label: const Text("Add Extra Bed"),
                              style: ElevatedButton.styleFrom(
                  ...
                  if (localCategory == "Dormitory" ||
                      ...
                      localCategory == "Meeting Hall" ||
                      localCategory == "Saptapadi Hall") ...[
                    const SizedBox(height: 20),
                    // --- 4. Add Other Services Section (HALLS/DORM ONLY) ---
                    Container(
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        color: brandPurple.withOpacity(0.05),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: brandPurple.withOpacity(0.3)),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text(
                            "4. ADD OTHER SERVICES (OPTIONAL)",
                            style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.bold,
                              color: brandPurple,
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: TextField(
                                  controller: otherServiceNameController,
                                  decoration: const InputDecoration(
                                    labelText: "Service Name (e.g. Lawn, Hall)",
                                    isDense: true,
                                    border: OutlineInputBorder(),
                                  ),
                                ),
                              ...
                              Expanded(
                                child: TextField(
                                  controller: otherServiceChargeController,
                                  keyboardType: TextInputType.number,
                                  decoration: const InputDecoration(
                                    labelText: "Charge (₹)",
                                    isDense: true,
                          ...
                          Center(
                            child: ElevatedButton.icon(
                              onPressed: () {
                                final name = otherServiceNameController.text
                                    .trim();
                                final charge =
                                    double.tryParse(
                                ...
                                if (name.isEmpty || charge <= 0) {
                                  messengerKey.currentState?.showSnackBar(
                                    const SnackBar(
                                      content: Text(
                                        "Please enter service name and valid charge",
                                      ),
                                    ),
                                  );
                                  return;
                  ...
                  // --- 5. BOOKING LIST ---
                  if (multiBookingItems.isNotEmpty) ...[
                    const Text(
                      "5. BOOKING LIST",
                      style: TextStyle(
                        fontSize: 12,
                    ...
                    SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        rows: multiBookingItems.asMap().entries.map((entry) {
                          final idx = entry.key;
                              ...
                              DataCell(
                                IconButton(
                                  ...
                                  onPressed: () => setModalState(
                                    () => multiBookingItems.removeAt(idx),
                                  ),
                                ),
                              ),
                            ],
                          ...
                          Row(
                            children: [
                              ...
                              ChoiceChip(
                                ...
                                onSelected: (v) =>
                                    setModalState(() => paymentMethod = "UPI"),
                              ),
                            ],
                          ),
                        ],
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Total Adv: ₹${totalAdv.toStringAsFixed(0)} | Rem: ₹${totalRem.toStringAsFixed(0)}",
                              style: const TextStyle(fontSize: 10),
                            ),
                          ],
                        ),
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: bookingType == "Confirm"
                          ? brandPurple
                          : Colors.orange,
                    ...
                    onPressed: _isSaving
                        ...
                        : () async {
                            if (nameController.text.isEmpty ||
                                ...
                                multiBookingItems.isEmpty ||
                                selectedDate == null ||
                                expectedCheckOutDate == null) {
                              messengerKey.currentState?.showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    "Please fulfill customer details, dates and at least one category",
                                  ),
                                ),
                              );
                              return;
                            ...
                            try {
                              ...
                              if (_idImage != null)
                                idImageUrl =
                                    await CloudinaryService.uploadIdProof(
                                      _idImage!,
                                    );
                              ...
                              final primaryItem = multiBookingItems.first;
                              ...
                              await ref
                                  ...
                                  .saveBooking(
                                    ...
                                    customerGst: gstNumberController.text
                                        .trim(),
                                    idProof: idProofController.text.trim(),
                                    category: primaryItem['category'],
                                    capacity: primaryItem['capacity'],
                                    unitNumbers: multiBookingItems
                                        .expand((i) => i['units'] as List)
                                        .toList(),
                                    reportingDate: selectedDate!,
                                    checkOutDate: expectedCheckOutDate!,
                                    advancePayment: totalAdv,
                                    roomRent: multiBookingItems.fold(
                                      0.0,
                                      (sum, i) =>
                                          sum +
                                          (i['package'] as num).toDouble(),
                                    ),
                                    gstAmount: multiBookingItems.fold(
                                      0.0,
                                      (sum, i) =>
                                          sum + (i['gst'] as num).toDouble(),
                                    ),
                                    discountAmount: multiBookingItems.fold(
                                      0.0,
                                      (sum, i) =>
                                          sum +
                                          (i['discount'] as num).toDouble(),
                                    ),
                                    remainingRent: totalRem,
                                    status: bookingType == "Confirm"
                                        ? "occupied"
                                        : "pre-booked",
                                    bookingItems: multiBookingItems,
                                  ...
                                  builder: (context) => AlertDialog(
                                    ...
                                    actions: [
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          Navigator.pop(context);
                                          // Generate booking data for receipt
                                          final receiptData = {
                                            'customerName': nameController.text
                                                .trim(),
                                            'phone': phoneController.text
                                                .trim(),
                                            'customerGst': gstNumberController
                                                .text
                                                .trim(),
                                            'reportingDate': Timestamp.fromDate(
                                              selectedDate!,
                                            ),
                                          ...
                                          ReceiptService.showPrintOptions(
                                            context,
                                            receiptData,
                                          );
                                        },
  ...
  Widget homePage() {
    ...
    return activeBookingsRef.when(
      data: (bookings) {
        ...
        final activeCheckIns = bookings
            .where((b) => b['status'] == 'occupied')
            .length;
        final cleaningUnits = bookings
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              const Text(
                "Click the button below to start a new multi-category booking for a customer.",
                textAlign: TextAlign.center,
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.info_outline, color: brandPurple),
                    const SizedBox(width: 15),
                    Expanded(
                      child: Text(
                        "You can now manage multiple room categories, units, and payment methods in a single booking session.",
        ...
        content: Column(
          ...
          children: [
            ...
            if (booking['status'] == 'pre-booked' &&
                booking['reportingDate'] != null)
              Text(
                "Reporting Date: ${(booking['reportingDate'] as Timestamp?)?.toDate().toString().split(' ')[0]}",
              ),
            if (booking['checkOutDate'] != null)
              Text(
                "Expected Check-Out: ${(booking['checkOutDate'] as Timestamp?)?.toDate().toString().split(' ')[0]}",
              ),
            const SizedBox(height: 10),
  ...
  Future<void> _confirmCheckInWithValidation(Map<String, dynamic> b) async {
    ...
    final hasId =
        b['idProof'] != null && b['idProof'].toString().trim().isNotEmpty;
        ...
        if (mounted) {
          messengerKey.currentState?.showSnackBar(
            SnackBar(
              ...
              content: Text("Checked-in ${b['customerName']}!"),
            ),
          );
        }
      } catch (e) {
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text(
                "This was a pre-booking. Please fill in the ID Proof details and Guest Photo to proceed.",
                    ...
                    Expanded(
                      child: _buildIdSlot(
                        ...
                        onTap: () async {
                          ...
                          if (file != null)
                            setDialogState(() => tempIdImage = file);
                        },
                    ...
                    Expanded(
                      child: _buildIdSlot(
                        ...
                        onTap: () async {
                          ...
                          if (file != null)
                            setDialogState(() => tempIdImageBack = file);
                        },
                        onClear: () =>
                            setDialogState(() => tempIdImageBack = null),
                      ),
                    ),
                  ],
                ),
              ...
              Row(
                children: [
                  ...
                  if (tempGuestPhoto != null) ...[
                    ...
                    IconButton(
                      onPressed: () =>
                          setDialogState(() => tempGuestPhoto = null),
              ...
              onPressed: isSavingLocal
                  ...
                  : () async {
                      if (idController.text.trim().isEmpty) {
                        messengerKey.currentState?.showSnackBar(
                          const SnackBar(content: Text("ID Proof is required")),
                        );
                        return;
                      }
                      ...
                      try {
                        String? idImageUrl;
                        if (tempIdImage != null) {
                          idImageUrl = await CloudinaryService.uploadIdProof(
                            tempIdImage!,
                          );
                        }
                        ...
                        String? guestPhotoUrl;
                        if (tempGuestPhoto != null) {
                          guestPhotoUrl = await CloudinaryService.uploadIdProof(
                            tempGuestPhoto!,
                          );
                        }
  ...
  void _showCheckOutDialog(Map<String, dynamic> booking) {
    final double advance =
        (booking['advancePayment'] as num?)?.toDouble() ?? 0.0;
    final double initialRemaining =
        (booking['remainingRent'] as num?)?.toDouble() ?? 0.0;
    ...
    final remainingController = TextEditingController(
      text: initialRemaining.toStringAsFixed(0),
    );
        ...
        builder: (context, setDialogState) {
          ...
          return AlertDialog(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Booking Rent (Advance already paid): ₹${advance.toStringAsFixed(0)}",
                    ...
                    Row(
                      children: [
                        ...
                        ChoiceChip(
                          ...
                          onSelected: (v) =>
                              setDialogState(() => selectedPaymentMode = "UPI"),
                        ),
                      ],
                    ),
                    const SizedBox(height: 20),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              "RENT BALANCE TO COLLECT ($selectedPaymentMode)",
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                                color: brandGreen,
                                fontSize: 14,
            ...
            actions: [
              TextButton(
                onPressed: () => Navigator.pop(context),
                child: const Text("CANCEL", style: TextStyle(color: brandPink)),
              ),
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: brandPurple,
                    ...
                    if (context.mounted) {
                      ...
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: const Text(
                            "Is this room already cleaned and ready for the next guest?",
                          ),
                          actions: [
                            TextButton(
                              onPressed: () async {
  ...
  void _showReceiptPrompt(Map<String, dynamic> booking) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          "Would you like to generate a receipt for this customer?",
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  await ref
                      .read(bookingRepositoryProvider)
                      .extendCleaning(booking['id'], selectedMinutes);
                  if (mounted) {
                    messengerKey.currentState?.showSnackBar(
                      SnackBar(
                        content: Text(
                          "Cleaning time extended by ${selectedMinutes}m",
                        ),
                      ),
                    );
                  }
    ...
    return allBookingsAsync.when(
      data: (bookings) {
        ...
        List<Map<String, dynamic>> filteredList = bookings.where((b) {
          final matchesSearch =
              b['customerName'].toString().toLowerCase().contains(
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              children: [
                ...
                Expanded(child: _historyListGrouped(filteredList, "all")),
              ],
            ),
          ),
        );
  ...
  Widget _historyListGrouped(List<Map<String, dynamic>> items, String type) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        final b = list[index];
        final inDate =
            (b['checkInAt'] as Timestamp?)?.toDate() ??
            (b['reportingDate'] as Timestamp?)?.toDate();
        final outDate =
            (b['checkOutAt'] as Timestamp?)?.toDate() ??
            (b['expectedCheckOutDate'] as Timestamp?)?.toDate();
        ...
        if (status == 'CLEANING') color = Colors.blueGrey;
            ...
            trailing: Row(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      "₹${b['advancePayment'] + (b['totalPayment'] ?? 0)}",
                      style: TextStyle(
                        color: brandPurple,
                        fontWeight: FontWeight.bold,
                      ),
            ...
            children: [
              TabBar(
                ...
                tabs: [
                  ...
                  Tab(
                    text: "Tomorrow · ${DateFormat('dd/MM').format(tomorrow)}",
                  ),
                ],
              ),
              Expanded(
  ...
  Widget _arrivalListFilter(
    ...
    final filtered =
        bookings.where((b) {
          ...
          final da =
              (a['reportingDate'] as Timestamp?)?.toDate() ?? DateTime.now();
          final db =
              (b['reportingDate'] as Timestamp?)?.toDate() ?? DateTime.now();
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (diff.isNegative) {
                    countdown = isPrebooked
                        ? 'Overdue ${diff.inHours.abs()}h'
                        : 'Checked In';
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      ...
                                      if (checkOutDate != null)
                                        _infoChip(
                                          Icons.logout,
                                          'Out: ${DateFormat('dd/MM').format(checkOutDate)}',
                                          Colors.blueGrey,
                                        ),
                                    ],
                                  ),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: countdownColor.withOpacity(
                                                0.12,
                                              ),
                                              borderRadius:
                                      ...
                                      if (isPrebooked)
                                        Wrap(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              onTap: () async {
                                                await _confirmCheckInWithValidation(
                                                  b,
                                                );
                                              },
                                              child: Container(
  ...
  Widget activeCheckInsPage() {
    ...
    return activeBookingsRef.when(
      data: (bookings) {
        ...
        if (occupied.isEmpty) {
          return const Center(
            child: Text("No active check-ins at the moment."),
          );
        }
        return Center(
          child: ConstrainedBox(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      "${FormatUtils.formatUnit(b['category'], b['unitNumber'])} · ${b['category']}",
                    ),
                    trailing: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
  ...
  void _showAddFoodDialog(Map<String, dynamic> b) {
    ...
    List<Map<String, dynamic>> localItems = List<Map<String, dynamic>>.from(
      b['foodBills'] ?? [],
    );
    File? stagedPhoto;
    int? editingIndex;
                            ...
                            onPressed: () {
                              ...
                              setDialogState(() {
                                final newItem = {
                                  ...
                                  'localPhoto':
                                      stagedPhoto, // Temporarily store File
                                  'imageUrl': editingIndex != null
                                      ? localItems[editingIndex!]['imageUrl']
                                      : null,
                                };
                        ...
                        try {
                          ...
                          for (var item in localItems) {
                            ...
                            if (item['localPhoto'] != null) {
                              url = await CloudinaryService.uploadIdProof(
                                item['localPhoto'] as File,
                              );
                            }
                          ...
                          await ref
                              .read(bookingRepositoryProvider)
                              .setFoodBills(b['id'], finalItems);
                          if (context.mounted) {
                            Navigator.pop(context);
                            messengerKey.currentState?.showSnackBar(
                              const SnackBar(
                                content: Text(
                                  "Food bills updated successfully!",
                                ),
                              ),
                            );
                          }
    ...
    return allBookingsAsync.when(
      data: (bookings) {
        ...
        if (departures.isEmpty) {
          return const Center(child: Text("No records for today."));
        }
              ...
              children: [
                Padding(
                  ...
                  child: _sectionHeader(
                    "Today's Activity (${departures.length})",
                    Icons.fact_check,
                  ),
                ),
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isCleaning = b['status'] == 'cleaning';
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            "Unit ${b['unitNumber']} | ${b['category']}\n${isCleaning ? 'IN CLEANING' : 'Checked-out'}",
                          ),
                          trailing: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (context.mounted) {
                                      ScaffoldMessenger.of(
                                        ...
                                        const SnackBar(
                                          content: Text("Unit marked as READY"),
                                        ),
                                      );
                                    }
                                  },
    ...
    return allBookingsAsync.when(
      data: (bookings) {
        ...
        final filteredBookings = bookings.where((b) {
          ...
          if (reportFilterStatus == "checked-out")
            return b['status'] == 'checked-out' || b['status'] == 'cleaning';
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  const Text(
                    "Filter the categories you want to include in the report:",
                  ...
                  Wrap(
                    ...
                    children: [
                      FilterChip(
                        ...
                        onSelected: (v) =>
                            setState(() => reportFilterStatus = "All"),
                        selectedColor: brandPurple.withOpacity(0.2),
                      ...
                      FilterChip(
                        ...
                        onSelected: (v) =>
                            setState(() => reportFilterStatus = "pre-booked"),
                      ...
                      FilterChip(
                        ...
                        onSelected: (v) =>
                            setState(() => reportFilterStatus = "occupied"),
                      ...
                      FilterChip(
                        ...
                        onSelected: (v) =>
                            setState(() => reportFilterStatus = "checked-out"),
                        selectedColor: brandPurple.withOpacity(0.2),
                        checkmarkColor: brandPurple,
                      ),
                    ],
                    ...
                    child: Column(
                      children: [
                        ElevatedButton.icon(
                          ...
                          label: Text(
                            "GENERATE ${reportFilterStatus.toUpperCase()} REPORT",
                            style: const TextStyle(fontWeight: FontWeight.bold),
                          ),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: brandPurple,
    ...
    return Consumer(
      builder: (context, ref, child) {
        ...
        return activeBookingsAsync.when(
          data: (bookings) {
            final now = DateTime.now();
            final cleaningBookings = bookings.where((b) {
              if (b['status'] != 'cleaning') return false;

              // Optionally exclude units where cleaning timer has already expired
              // Or just show them so staff can clear them. We'll show them.
              return true;
            }).toList();

            if (cleaningBookings.isEmpty) {
              return Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      "No units currently in cleaning.",
            ...
            return RefreshIndicator(
              onRefresh: () async {
                // Refresh provider if needed, or just let stream handle it
              },
              child: ListView.builder(
                padding: const EdgeInsets.all(16),
                itemCount: cleaningBookings.length,
                itemBuilder: (context, index) {
                  final b = cleaningBookings[index];
                  final cleanUntil = (b['cleaningUntil'] as Timestamp?)
                      ?.toDate();
                  ...
                  if (cleanUntil != null) {
                    if (now.isAfter(cleanUntil)) {
                      timeStr = "Ready (Timer Expired)";
                      statusColor = brandGreen;
                    } else {
                      final diff = cleanUntil.difference(now);
                      timeStr =
                          "Cleaning Ends in: ${diff.inHours}h ${diff.inMinutes % 60}m";
                    }
                  } else {
                    timeStr = "Timer Not Set";
                  }

                  // Handle multiple units if array exists
                  String unitDisplay = b['unitNumber']?.toString() ?? "Unknown";
                  if (b['unitNumbers'] != null &&
                      (b['unitNumbers'] as List).isNotEmpty) {
                    unitDisplay = (b['unitNumbers'] as List).join(", ");
                  }
                            ...
                            child: ElevatedButton.icon(
                              ...
                              onPressed: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      "Unit $unitDisplay marked as ready.",
                                    ),
                                  ),
                                );
                              },
  ...
  Widget _sectionHeader(String t, IconData i) {
    return Row(
      children: [
        Icon(i, size: 20, color: brandPurple),
        const SizedBox(width: 8),
        Text(
          t,
  ...
  Widget build(BuildContext context) {
    List<Widget> pages = [
      ...
      historyPage(),
      settingsPage(),
      cleaningPage(), // Index 4: Explicit page for Cleaning
      arrivalsPage(), // Index 5
      checkOutsPage(), // Index 6
      reportsPage(), // Index 7
      activeCheckInsPage(), // Index 8
    ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: brandPurple,
        foregroundColor: Colors.white,
        leading: (_currentIndex >= 5 && _currentIndex <= 8)
            ? IconButton(
